...
- [**Elastic**](https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/elastic.co/) - Search & observability platform. Blue-primary enterprise UI, EUI Borealis design system
